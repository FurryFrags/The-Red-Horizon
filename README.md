...
- Province polygons are fetched in real time from the [geoBoundaries](https://www.geoboundaries.org/) ADM1 API, with CDN/raw mirror fallbacks, and then mapped to mission provinces.
